...
- type (merge types into fewer categories) There are so may types of refrigerators, but the main categories can be the next ones:
...
I found that in many case the first 3 words is enough to identify an item, however sometime 4 words is better, and sometimes 4 words is wost than 3 words.
I decided to go on merging tems by technical attributes as well.
